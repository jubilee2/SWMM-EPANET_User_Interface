...
class SwmmInterfaceBase:
    ...
    def tr(self, message):
        ...
        return QCoreApplication.translate('SwmmInterface', message)
    ...
    def add_action(
        ...
        if add_to_toolbar:
            ...
            if add_to_toolbar_name in self.toolbar_dict:
                self.toolbar_dict[add_to_toolbar_name].addAction(action)
            else:
